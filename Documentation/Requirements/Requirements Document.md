...
| "Избранное" | При нажатии происходит переход к окну "Избранное" .  | 
| "Карта" | При нажатии происходит переход к карте с маркерами всех достопримечательностей.   |
| "Поиск" | При нажатии происходит переход к окну поиска по названию.   |
...
| "Назад" | Возврат в предыдущее окно.   |
...
| Функция | Требования | 
|:---|:---|
| Отображение карты с маркерами | Маркеры должны соответствовать реальному местоположению объектов и пользователя.|
...
| Функция | Требования | 
|:---|:---|
| Ввод названия достопримечательности | Отображаются достопримечательности с полным или частичным совпаданием названия.    |
...
* Интернет соединение
* Внешний интерфейс API [MapKit – мобильный SDK](https://tech.yandex.ru/maps/mapkit/).
